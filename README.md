...
1. Go to the "Releases" tab on the right this webpage(or click [HERE](https://github.com/tw4449-s-MAS-Submods/Custom-Room-Furnished-Spaceroom-V2/releases)), then click on the latest version of "Custom Room Furnished Spaceroom V2". To download click on Source code (zip) to begin.

2. Unzip and open the folder called 'Custom-Room-Furnished-Spaceroom-V2' (it should be in your 'Downloads' folder).

3. From the Custom-Room-Furnished-Spaceroom-V2 folder, copy the 'game' and 'lib' folders into the main
